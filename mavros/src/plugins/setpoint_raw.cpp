...
public:
	...
	void initialize(UAS &uas_) override
	{
		...
		rpyrt_sub = sp_nh.subscribe("roll_pitch_yawrate_thrust", 1, &SetpointRawPlugin::rpyrt_cb, this);
...
private:
	...
	ros::Subscriber local_sub, global_sub, attitude_sub, rpyrt_sub;
	...
	void rpyrt_cb(const mav_msgs::RollPitchYawrateThrustConstPtr &msg)
    {
